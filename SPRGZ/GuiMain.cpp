...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CREATE:
		...
		createCombobox("Типы", new ViewParam{ 370, 10, 150, 500 }, types, sizeof(types) / sizeof(types[0]), cb_list_types_id, hwnd);
		...
		createText("Чтение", new ViewParam{ 50, 60, 100, 20 }, NULL, hwnd);
		createText("Запись", new ViewParam{ 250, 60, 100, 20 }, NULL, hwnd);
